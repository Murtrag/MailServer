...
def test_check_password():
	...
	assert True == clcrypto.check_password(
		password,
		hash
	)
	assert False == clcrypto.check_password(
...
def test_check_pass_len():
	assert True == clcrypto.check_pass_len("asdfghjk")
	assert False == clcrypto.check_pass_len("as12")
